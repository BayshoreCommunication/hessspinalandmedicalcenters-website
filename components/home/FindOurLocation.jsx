      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col  items-center justify-between gap-5 lg:gap-8">
          ...
          <div className="relative w-full flex items-center  gap-10">
            <button className="hidden lg:block text-white bg-primary  hover:text-primary hover:bg-transparent hover:border-primary p-3 border border-white rounded-full duration-400">
              <FaArrowLeft size={20} />
            </button>
